  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved domain as @domain" do
        ...
        post :create, {:domain => { "name" => "invalid value" }}, valid_session
        expect(assigns(:domain)).to be_a_new(Domain)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested domain" do
        ...
        expect_any_instance_of(Domain).to receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => domain.to_param, :domain => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the domain as @domain" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Domain.any_instance.stub(:save).and_return(false)
        put :update, {:id => domain.to_param, :domain => { "name" => "invalid value" }}, valid_session
        expect(assigns(:domain)).to eq(domain)
      end
